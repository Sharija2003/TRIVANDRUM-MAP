...
map.getView().fit([8515483.768522, 906403.577623, 8600803.004702, 994323.400135], map.getSize());
    ...
    element: (() => {
        ...
        if (317 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'THIS IS THE ELABORATED MAP OF TRIVANDRUM.THIS MAP INCLUDES THE DISTINCTIVE CULTURAL AND PHYSICAL FEATURES. THE MAIN PHYSICAL FEATURES INCLUDED ARE ,THE SOIL TEXTURE,DRAINAGE,BEACHES ETC. THE MANMADE FEATUERES INCLUDES THE JUNCTION, ROAD AND RAILWAY LINE OF THIS PARTICULAR DISTRICT. IMAGES OF THE BEACHES ARE ATTACHED';
            }
